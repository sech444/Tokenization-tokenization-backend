...
//         let claims = Claims {  // Subject (user ID)
//             user_id: user.id,
...
//         // Same as generate_token but you might want to add different logic
...
// // Uncomment and modify if you need admin-only middleware
// // #[async_trait]
...
// //         match claims.role {
// //             UserRole::Admin => Ok(RequireAdmin),
// //             _ => Err(AuthError {
